...
if __name__ == '__main__':
    ...
    # shape = 'eight'
    # data_dir = BESTAnP_dir + f"/data/{shape}/sonar_data.csv"
    # noisy_data_dir = BESTAnP_dir + f"/data/{shape}/sonar_data_noisy.csv"
    # sonar_data_write = SonarDataWriter(data_dir, noisy_data_dir)
    # sonar_data_write.write()
    
    filepath = "/home/clp/catkin_ws/src/BESTAnP/data_old/circle/sonar_data.csv"
